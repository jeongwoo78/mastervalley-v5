...
const SUGGESTED_QUESTIONS = {
  ...
  'KLIMT': ['귀걸이 달아줘', '키스 그림 모델이 누구예요?', '왜 금색을 좋아해요?'],
  'MUNCH': ['옷 색깔 바꿔줘', '결혼했어요?', '절규는 왜 그렸어요?'],
  'CHAGALL': ['귀걸이 달아줘', '사랑해 봤어요?', '동물들을 좋아해요?'],
  'PICASSO': ['옷 색깔 바꿔줘', '여자친구 많았어요?', '왜 얼굴을 이상하게 그려요?'],
  'MATISSE': ['옷 색깔 바꿔줘', '소개해주세요', '왜 색이 이렇게 밝아요?'],
